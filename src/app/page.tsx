            ...
            <div className="w-full space-y-8">
              <div className="p-6 border border-white/10 rounded-xl backdrop-blur-sm bg-white/5 shadow-xl">
                ...
                <p className="text-gray-300 text-center leading-relaxed">
                  ประสบการณ์ทำงานจริง{" "}
                  <span className="font-semibold text-blue-400">2 ปี</span>
                  โดยอิงจากการทำงานเป็น
                  <span className="underline decoration-blue-400">
                    ผู้ช่วยนักวิจัย
                  </span>
                  ให้กับมหาลัยกรุงเทพ ตำแหน่ง{" "}
                  <span className="font-semibold text-purple-400">
                    Developer
                  </span>
                  <br />
                  ผมเป็นคนที่มี<span className="italic">ไฟในการทำงาน</span>
                  และสามารถเข้ากับคนได้ง่าย รวมถึงการเรียนรู้ในสิ่งใหม่ ๆ
                  ตลอดเวลา และสามารถรับรู้สิ่งต่าง ๆ ได้อย่างรวดเร็ว
                </p>
              </div>
              <div className="p-6 border border-white/10 rounded-xl backdrop-blur-sm bg-white/5 shadow-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
              ...
              <div className="p-6 border border-white/10 rounded-xl backdrop-blur-sm bg-white/5 shadow-xl flex flex-col items-center text-center transition-transform hover:scale-105">
                ...
                <p className="text-gray-300">
                  ...
                  Flutter and for native app development using XCode and Android
                  Studio.
                </p>
              </div>
              ...
              <div className="p-6 border border-white/10 rounded-xl backdrop-blur-sm bg-white/5 shadow-xl flex flex-col items-center text-center transition-transform hover:scale-105">
                ...
                <h3 className="text-xl font-bold mb-2">AI Model Training</h3>
                <p className="text-gray-300">
                  Custom machine learning model development and training for
                  various applications and data-driven solutions.
                </p>
              </div>
        ...
        {activeTab === "contact" && (
          <div className="flex flex-col items-center justify-center min-h-screen w-full max-w-3xl px-6 py-12 mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mb-10">
              <div
                className="p-4 border border-white/10 rounded-xl backdrop-blur-sm bg-white/5 shadow-xl flex flex-col items-center text-center hover:bg-white/10 transition-colors cursor-pointer"
                onClick={() => window.open("mailto:sparkpzch@gmail.com")}
              >
              ...
              <a
                href="tel:+66925976004"
                className="p-4 border border-white/10 rounded-xl backdrop-blur-sm bg-white/5 shadow-xl flex flex-col items-center text-center hover:bg-white/10 transition-colors"
              >
              ...
              >
                ...
                <p className="text-gray-400 text-sm hover:text-green-400 transition-colors">
                  Bangkok, Thailand
                </p>
              </a>
            </div>
            ...
            <div className="mt-10 w-full flex flex-col md:flex-row gap-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 p-4 border border-white/10 rounded-xl backdrop-blur-sm bg-white/5 shadow-xl flex items-center justify-center gap-3 hover:bg-blue-900/20 transition-all"
              >
                <svg
                  className="h-6 w-6"
                  fill="currentColor"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 p-4 border border-white/10 rounded-xl backdrop-blur-sm bg-white/5 shadow-xl flex items-center justify-center gap-3 hover:bg-gray-800/50 transition-all"
              >
                <svg
                  className="h-6 w-6"
                  fill="currentColor"
